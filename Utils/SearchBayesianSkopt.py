...
from Utils.SearchAbstractClass import SearchAbstractClass
import traceback
...
class SearchBayesianSkopt(SearchAbstractClass):
    ...
    def search(self, recommender_input_args,
        ...
        skopt_types = [Real, Integer, Categorical] #Make sure to always specify the variables to be of those tyes
